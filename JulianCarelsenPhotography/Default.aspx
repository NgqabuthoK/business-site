...
<body>
    ...
    <div id="top" class="header">
      <div class="vert-text">
	  <img class="img-rounded" alt="Company Logo" src="./img/JulianCarelsenPhotography.png"/>
    ...
    <div class="row push50">
          <div class="col-md-4 col-md-offset-4 text-center">
			...
			<span class="filter label label-default" data-filter="all">ALL</span>
                <!-- Changed the data-filter attribute from portraits to its respective category -->
    ...
    <span class="filter label label-default" data-filter="landscapes">Landscapes</span>
		...
		<div class="gallery">
              ...
              <a data-toggle="modal" data-target="#portrait1" class="mix-cover">
    		    ...
    		    <li class="col-md-4 col-sm-4 col-xs-12 mix landscapes" data-cat="landscapes">
                <a data-toggle="modal" data-target="#Landsacape3" class="mix-cover">
                  <img class="horizontal" src="img/Landscape3.jpg" alt="placeholder">
        		      <span class="overlay"><span class="valign"></span><span class="title">Landscape 3</span></span>
                </a>                
      		  </li>
			  ...
			  <li class="col-md-4 col-sm-4 col-xs-12 mix bw nature all" data-cat="bw">
                ...
                <a data-toggle="modal" data-target="#Fashion1" class="mix-cover green">
                  <img class="vertical" src="img/Fashion1.jpg" alt="landscapes">
                ...
                <a data-toggle="modal" data-target="#Fashion2" class="mix-cover green">
                  <img class="vertical" src="img/Fashion2.jpg" alt="landscapes">
                   <span class="overlay"><span class="valign"></span><span class="title">Fashion</span></span>                  
        		    </a>
      		  </li>
                ...
                <a data-toggle="modal" data-target="#Fashion3" class="mix-cover green">
                  <img class="vertical" src="img/Fashion3.jpg" alt="landscapes">
                   <span class="overlay"><span class="valign"></span><span class="title">Fashion</span></span>                  
        		    </a>
      		  </li>
                ...
                <a data-toggle="modal" data-target="#Fashion4" class="mix-cover green">
                  <img class="vertical" src="img/Fashion4.jpg" alt="landscapes">
                   <span class="overlay"><span class="valign"></span><span class="title">Fashion</span></span>                  
        		    </a>
      		  </li>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
       <img class="thumbnail" alt="forest" src="img/bw1.jpg"/>
            ...
            <!--Newly inserted modals for JC pictures -->
        ...
        <div class="row">
          <div class="col-md-8 col-md-offset-2 text-center">
            <h2>About Us</h2>
              <br />
              <br />
              <img class="img-rounded" alt="Julian Carelsen" src="./img/JulianCarelsen.jpg"/>
...
<!-- Slideshow Background  -->
	<script>
	    $.vegas('slideshow', {
	        delay: 5000,
	        backgrounds: [
             //  { src: './img/nature1.jpg', fade: 2000 }, //Not a JC Picture.
               //{ src: './img/bw1.jpg', fade: 2000 }, //Not a JC Picture.
              //{ src: './img/portrait1.jpg', fade: 2000 }, //Not a JC Picture.
              { src: './img/Birds.jpg', fade: 4000 },
               //{ src: './img/portrait5.jpg', fade: 2000 }, //Not a JC Picture.
               { src: './img/MosesMabhida.jpg', fade: 4000 },
              { src: './img/Home2.jpg', fade: 2000 }, 
              { src: './img/Durban.jpg', fade: 4000 },
              //{ src: './img/portrait3.jpg', fade: 2000 }, //Not a JC Picture.
               //{ src: './img/portrait4.jpg', fade: 2000 }, //Not a JC Picture.
                { src: './img/OkuhleTamella.jpg', fade: 4000 },
                { src: './img/Home1.jpg', fade: 2000 },
                // { src: './img/forest.jpg', fade: 2000 } //Not a JC Picture.
